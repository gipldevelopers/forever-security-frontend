...
async getAlbums() {
    return this.request('api/gallery/albums');
}

async getAlbumById(albumId) {
    return this.request(`api/gallery/albums/${albumId}`);
}
...
async createAlbum(albumData) {
    ...
    return this.request('api/gallery/albums', {
        method: 'POST',
        body: albumData, // FormData object
    });
}
...
async addImageToAlbum(imageData) {
    // Note: This will be handled with FormData in the component
    return this.request('api/gallery/images', {
        method: 'POST',
...
async deleteImage(imageId) {
    return this.request(`api/gallery/images/${imageId}`, {
        method: 'DELETE',
    });
}
